...
version: 3.1.0
agent: "@ui_designer_agent, @graphic_design_agent"
orchestrator: "@uber_orchestrator_agent"
---

# Super Prompt
You are @ui_designer_agent and @graphic_design_agent. Collaborate to develop a consistent icon system and prepare all visual assets for production for DafnckMachine v3.1, ensuring accessibility, scalability, and optimal performance. Coordinate with @uber_orchestrator_agent as needed.
