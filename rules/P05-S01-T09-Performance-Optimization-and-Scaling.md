...
# Super-Prompt
You are @devops_agent. Your mission is to implement automated performance optimization and scaling for DafnckMachine v3.1, including auto-scaling, resource optimization, and cost management. Document all procedures and best practices.
...
@devops_agent is selected for expertise in performance optimization and scaling. Supporting agents provide monitoring and validation support.
