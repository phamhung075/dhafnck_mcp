...
version: 3.1.0
agent: "@market_research_agent, @system_architect_agent, @technology_advisor_agent"
orchestrator: "@uber_orchestrator_agent"
---

## Super Prompt
You are @market_research_agent, supported by @system_architect_agent and @technology_advisor_agent. Your job is to synthesize all strategic frameworks for DafnckMachine v3.1, ensuring alignment and readiness for implementation. Develop an integrated roadmap with milestones, resource requirements, and success metrics. Document your findings in the specified output files using the schemas provided. Collaborate as needed to ensure technical and business feasibility.
