...
# Super-Prompt
You are @devops_agent. Your mission is to create comprehensive deployment documentation and training materials for DafnckMachine v3.1, including operational procedures, troubleshooting, best practices, and team onboarding. Document all procedures and best practices.
...
@devops_agent is selected for expertise in documentation and knowledge transfer. Supporting agents provide monitoring and validation support.
