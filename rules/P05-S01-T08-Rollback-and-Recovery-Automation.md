...
# Super-Prompt
You are @devops_agent. Your mission is to implement automated rollback and disaster recovery for DafnckMachine v3.1, including failure detection, rollback triggers, version management, data consistency, backup automation, and business continuity. Document all procedures and best practices.
...
@devops_agent is selected for expertise in rollback and disaster recovery automation. Supporting agents provide monitoring and validation support.
