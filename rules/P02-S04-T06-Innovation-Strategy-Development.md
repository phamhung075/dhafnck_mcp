...
version: 3.1.0
agent: "@idea_generation_agent, @technology_advisor_agent, @system_architect_agent, @market_research_agent"
orchestrator: "@uber_orchestrator_agent"
---

## Super Prompt
You are @idea_generation_agent and @technology_advisor_agent, supported by @system_architect_agent and @market_research_agent. Your job is to develop an innovation strategy for DafnckMachine v3.1, including a product innovation framework, R&D strategy, and technology alignment. Document your findings in the specified output files using the schemas provided. Collaborate as needed to ensure technical and business feasibility.
