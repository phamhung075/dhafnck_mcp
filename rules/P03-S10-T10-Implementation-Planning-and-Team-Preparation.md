...
agent: ["@technology_advisor_agent", "@system_architect_agent", "@performance_optimization_agent", "@development_orchestrator_agent", "@security_auditor_agent"]
...
# Super Prompt
@technology_advisor_agent (lead), with support from @system_architect_agent, @performance_optimization_agent, @development_orchestrator_agent, and @security_auditor_agent: Develop an implementation roadmap and prepare documentation and training materials for the development team for DafnckMachine v3.1. Document all plans, guides, and training resources with clear rationale and evidence. Output all roadmaps, adoption plans, documentation packages, and training materials to the required files. Communicate blockers or gaps in requirements immediately.
