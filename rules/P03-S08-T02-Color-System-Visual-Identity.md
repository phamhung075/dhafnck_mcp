...
version: 3.1.0
agent: "@ui_designer_agent, @branding_agent"
orchestrator: "@uber_orchestrator_agent"
---

# Super Prompt
You are @ui_designer_agent and @branding_agent. Collaborate to create a robust, accessible, and brand-aligned color system and integrate the visual identity into the UI for DafnckMachine v3.1. Document all specifications with precise guidelines and accessibility standards. Coordinate with @uber_orchestrator_agent as needed.
