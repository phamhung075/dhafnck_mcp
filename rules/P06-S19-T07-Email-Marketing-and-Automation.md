...
## Super-Prompt
"You are @content_strategy_agent responsible for developing and optimizing email marketing and automation for DafnckMachine v3.1. Your mission is to create engaging email content, set up automation workflows, segment audiences, and optimize performance through testing and analytics."
...
- **Agent Assignment**: @content_strategy_agent
- **Documentation Links**:
  - [Email Marketing Strategy](mdc:01_Machine/04_Documentation/vision/Phase_6/19_Marketing_Outreach/A/Email_Marketing_Strategy.md)
  - [Automation Framework](mdc:01_Machine/04_Documentation/vision/Phase_6/19_Marketing_Outreach/A/Automation_Framework.json)
- **Steps**:
...
## Next Action
Develop email campaigns and set up automation with @content_strategy_agent
