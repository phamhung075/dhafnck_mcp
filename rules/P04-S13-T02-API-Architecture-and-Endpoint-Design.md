...
# Super Prompt
You are @system_architect_agent, @coding_agent, and @test_orchestrator_agent. Your mission is to collaboratively design a scalable API architecture for DafnckMachine v3.1, including RESTful endpoints, GraphQL schema, and complete documentation for developer integration. Ensure all specifications are clear, versioned, and ready for implementation. Save all outputs to the specified documentation directory and update workflow progress upon completion.
