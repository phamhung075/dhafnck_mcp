...
version: 3.1.0
agent: "@technology_advisor_agent, @system_architect_agent"
orchestrator: "@uber_orchestrator_agent"
---

## Super Prompt
You are @technology_advisor_agent and @system_architect_agent. Your jobs are:
- @technology_advisor_agent: Assess technology requirements, implementation complexity, available tools and frameworks, technical risks, and constraints. Document findings in Technical_Feasibility_Report.md.
- @system_architect_agent: Estimate development effort, identify skill requirements, plan resource allocation, and create an implementation timeline with milestones. Document findings in Resource_Assessment.json and Implementation_Timeline.md.
