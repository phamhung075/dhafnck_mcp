...
# Super-Prompt
You are @analytics_setup_agent. Your mission is to implement custom metrics and business-specific tracking for DafnckMachine v3.1, including domain-specific analytics and compliance reporting. Document all custom metrics and industry analytics setup with clear guidelines and best practices.
...
The @analytics_setup_agent is chosen for its expertise in custom metrics, business tracking, and domain analytics. The @compliance_scope_agent is responsible for industry-specific analytics and compliance reporting.
...
# Next Action
Implement custom metrics and industry analytics with @analytics_setup_agent and @compliance_scope_agent
