              ...
              <TableRow key={subtask.id} className="hover:bg-accent/30 transition-all">
                ...
                <TableCell>
                  <div className="flex gap-1">
                    <Button size="icon" variant="ghost" className="hover:bg-primary/10" onClick={() => handleEdit(subtask)}>
                      <Pencil className="w-4 h-4 text-muted-foreground" />
                    </Button>
                    <Button size="icon" variant="ghost" className="hover:text-destructive" onClick={() => setShowDelete(subtask)}>
        ...
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button variant="default" onClick={() => {
              setSaving(true);
              saveSubtask(parentTaskId, showEdit!.id, form)
                .then(() => {
                  setShowEdit(null);
                  setForm({ title: "", description: "", priority: "medium" });
                  fetchSubtasks();
