...
def load_all_env_vars() -> dict:
    ...
    # print(f"🔍 REDIS_PASSWORD loaded: {redis_pwd}")
...
if exported_vars:
    print(f"🔧 Exported to current process: {', '.join([v.split('=')[0] for v in exported_vars])}")
...
def create_docker_env_file():
    ...
    print(f"🔧 Created docker/.env file for Docker Compose")
...
def run_subprocess(cmd, **kwargs):
    ...
    #     print(f"🔍 Docker Compose DOWN Command - REDIS_PASSWORD: {redis_pwd_value}")
