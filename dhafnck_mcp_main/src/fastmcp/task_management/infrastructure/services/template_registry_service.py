"""
Template Registry Service - Infrastructure Layer
Handles template persistence, discovery, and database operations
"""
...
class TemplateRegistryService:
    """
    Template registry with AI-powered suggestions and usage tracking
    ...
    def __init__(self, db_path: Optional[Path] = None):
        ...
        if db_path:
            ...
            self.db_path = Path(__file__).parent.parent.parent.parent.parent / "database" / "data" / "dhafnck_mcp.db"
        logger.info(f"TemplateRegistry initialized with database: {self.db_path}")
