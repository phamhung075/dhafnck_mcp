...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| action | string | Yes | Project operation: 'create', 'get', 'list', 'update', 'project_health_check', 'cleanup_obsolete', 'validate_integrity', 'rebalance_agents' |
...
| force | boolean | Optional | Force maintenance operations (default: false) |
...
| agent_id | string | Conditional | Agent identifier (required for assign/unassign operations) |
