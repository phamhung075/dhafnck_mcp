...
- **[automatic-context-vision-updates.md](automatic-context-vision-updates.md)** - Enforce context updates
...
- **[subtask-automatic-progress-tracking.md](subtask-automatic-progress-tracking.md)** - Subtask integration
...
4. **Phase 4: Subtask Progress** - Automatic parent task updates
