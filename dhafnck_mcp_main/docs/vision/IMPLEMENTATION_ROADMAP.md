...
1. **[automatic-context-vision-updates.md](automatic-context-vision-updates.md)**
   - Read sections: "Block Task Completion Without Updates", "New Combined Actions"
   - Focus on: How to enforce context requirements
...
src/fastmcp/task_management/interface/controllers/task_mcp_controller.py
  ...
  - Reference: automatic-context-vision-updates.md - "Modified manage_task Tool"
...
src/fastmcp/task_management/interface/controllers/context_enforcing_controller.py
  - Reference implementation in automatic-context-vision-updates.md
...
### Objective
Ensure subtask updates automatically update parent task progress and context.

### Documents to Read

1. **[subtask-automatic-progress-tracking.md](subtask-automatic-progress-tracking.md)** - **PRIMARY DOCUMENT**
   - Read: Entire document
   - Focus on: Progress calculation, context propagation
...
src/fastmcp/task_management/interface/controllers/subtask_progress_controller.py
  - Reference implementation in subtask-automatic-progress-tracking.md
...
src/fastmcp/task_management/interface/controllers/subtask_mcp_controller.py (if exists)
  - Add automatic parent progress calculation
  - Add context propagation on subtask complete
...
- Update progress (auto context)
- Work on subtasks (auto parent update)
...
4. `subtask_progress_controller.py` - Auto parent updates
