...
A comprehensive PostgreSQL-based document management system with full-text search, semantic search, and MCP integration.

- [**System Overview**](claude-document-management-system/README.md) - Complete system guide and quick start
...
- [End-to-End Testing Guidelines](tests/e2e/End_to_End_Testing_Guidelines.md) - E2E testing best practices
- [Context Resolution Tests Summary](tests/context_resolution_tests_summary.md) - Context resolution test results
- [Context Resolution TDD Tests](tests/context_resolution_tdd_tests.md) - TDD approach for context tests
...
- [Automatic Context Vision Updates](vision/automatic-context-vision-updates.md) - Enforce context updates
- [Implementation Guide Server Enrichment](vision/implementation-guide-server-enrichment.md) - Auto-enrich responses
- [Subtask Automatic Progress Tracking](vision/subtask-automatic-progress-tracking.md) - Subtask integration
...
- **Context Synchronization**: Added automatic context updates on task state changes
