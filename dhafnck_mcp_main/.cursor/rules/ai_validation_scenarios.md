...
# 6. Get full context
context = manage_hierarchical_context(action="resolve", level="project", 
...
manage_hierarchical_context(action="update", level="task", context_id=task_id,
                           data={
...
manage_hierarchical_context(action="delegate", level="task", context_id=task_id,
                           delegate_to="project",
                           delegate_data={
...
current_project_context = manage_hierarchical_context(
...
new_context = manage_hierarchical_context(
...
context = manage_hierarchical_context(action="resolve", level="task", context_id=auth_bug_task_id)
...
manage_hierarchical_context(action="delegate", level="task", context_id=auth_bug_task_id,
                           delegate_to="global",
                           delegate_data={
