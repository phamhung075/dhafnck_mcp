execute comprehensive MCP tool testing following the specified protocol: test → stop on error → fix with DDD compliance → restart backend → verify in Supabase → retest


by calling tools actions direct
