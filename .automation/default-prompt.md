...
- **Analysis Time:** Mon Aug 18 15:41:01 CEST 2025
- **Commit Hash:** b70195cbc9adfb879f93926e1f1c03e30160478a


## 📝 Missing Test Files (Need Creation)

### 📄 `dhafnck-frontend/src/components/auth/EmailVerification.tsx`
- **Missing Test:** `dhafnck-frontend/src/tests/components/auth/EmailVerification.test.tsx`
- **Reason:** missing
- **Priority:** HIGH
- **Source Lines:** 199

### 📄 `dhafnck-frontend/src/components/auth/SignupForm.tsx`
- **Missing Test:** `dhafnck-frontend/src/tests/components/auth/SignupForm.test.tsx`
- **Reason:** missing
- **Priority:** HIGH
- **Source Lines:** 532
